...
public class AclTest {
    ...
    public void givenOwnerUser_whenGetPossession_thenOk() {
        Response response = givenAuth("armen@email.com", "Secured123!").get(APP_ROOT + "/possessions/2");
    ...
    public void givenUserWithReadPermission_whenGetPossession_thenOK() {
        Response response = givenAuth("eric@email.com", "Secured123!").get(APP_ROOT + "/possessions/2");
        assertEquals(200, response.getStatusCode());
        assertTrue(response.asString().contains("id"));
    }
    ...
    public void givenUserWithNoPermission_whenGetPossession_thenForbidden() {
        Response response = givenAuth("armen@email.com", "Secured123!").get(APP_ROOT + "/possessions/3");
